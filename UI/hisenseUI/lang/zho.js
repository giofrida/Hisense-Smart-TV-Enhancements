...
"On Now":["正在播放"],
"You have reached the beginning of the guide":["您已到達指南開頭"],
"You have reached the end of the guide":["您已到達指南結尾"],
"News/Factual":["新聞/事實"],
"Entertainment":["娛樂"],
"Factual":["事實"],
"Programme not available.":["節目無法使用。"],
"Add friends":["新增好友"],
"Added":["已經增加過！"],
"Add success":["已經新增成功！"],
"Add failed":["新增失敗！"],
...
"Restore all the picture settings in the current picture mode to the factory default values.":["將目前影像模式的相關設定恢復到出廠值"],
"Cool":["冷色"],
"Yellow":["黃色"],
"Cyan":["青色"],
"Magenta":["洋紅色"],
...
"Restore all of the audio settings in current audio mode to the factory default values.":["將目前音訊模式的相關設定恢復到出廠值"],
"Tuner Mode:":["調諧模式:"],
"Tuner Mode":["調諧模式"],
...
"Review the Advanced Settings menu -Common interface -CI card and PIN -CAM Profile search":["檢視進階設定功能表。 \n-公用介面 \n-CI 卡與 PIN \n-搜尋 CAM 設定檔"],
...
"Latvia":[""],
"Lithuanija":[""],
"Maximum supported disk size is 32GB":["最大支援磁碟容量為 32GB。"],
"Tamil":["Tamil"],
"Bahasa Melayu":["馬來語"],
"Jalai":["伊朗曆"],
...
"Min":["分"],
"Audio":["聲道"],
"Press Left/Right button to adjust the available size.":["按「左/右」按鍵調整可用尺寸。"],
