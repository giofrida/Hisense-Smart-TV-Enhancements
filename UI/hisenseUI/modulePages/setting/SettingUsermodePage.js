...
//            "setting_sys_mode_txt2":{Data:"Premium model default settings are recommended for in-home use.ENERGY ATAR qualified."}
//        }
    ...
    "langData":{
      ...
      //  "Store Mode": ["Store Mode","Mode magasin","Modo de almacenamiento"],
        "Optimizes the picture for store environments": [],
    ...
    //    "Retail mode provides an overview of the key features and functionalities of the TV.":[],
     ...
     //   "Home model default settings are recommended for in-home use.ENERGY ATAR qualified.":["Home model default settings are recommended for in-home use.ENERGY ATAR qualified.","",""],
        //"Premium model default settings are recommended for in-home use.ENERGY ATAR qualified.":["Premium model default settings are recommended for in-home use.ENERGY ATAR qualified.","",""]
