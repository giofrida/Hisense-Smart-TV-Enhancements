...
//                "aftUpHandler":"SettingSysadfocus",
        ...
        },
        {
            ...
            "nav":{"downTo": "setting_sys_ad_btn7", "upTo": "setting_sys_ad_btn6"},
            "handler": {
                "aftDownHandler":"SettingSysadfocus",
                "aftUpHandler":"SettingSysadfocus",
        ...
        },
        {
            ...
            "nav":{"downTo": "setting_sys_ad_control2", "upTo": "setting_sys_ad_btn7"},
            "handler": {
                "aftDownHandler":"SettingSysadfocus",
                "aftUpHandler":"SettingSysadfocus",
...
function SettingadInit()
{
   try
   {
    ...
    debugPrint("getPowerIndicator"+JSON.stringify(PageDataSettingSysAd.operateData.setting_sys_ad_control2.switchType));
     ...
     debugPrint("get em subtitle mode"+ PageDataSettingSysAd.operateData.cursubmode);
     if(PageDataSettingSysAd.operateData.cursubmode>1)
     {
         PageDataSettingSysAd.operateData.cursubmode=1;
         model.basicSetting.setEnumDvbModeSubtitle(1);
     }
	 
    var temp2=model.source.getInputName();
    var element={};
    debugPrint("get the em input list is "+JSON.stringify(temp2));
