...
//            {
//                "title":"Audio Only",
//                "content":"Turn off the TV screen but continue to listen to the audio. Press any key except the Power and Volume buttons on the remote to turn the screen On."
//            },
            {
...
//                },
        ...
        "picData": {
            ...
            picModeVec: ["Standard", "Natural", "Theatre", "PC/Game", "Dynamic"],
...
//
  //          }
//            if(PageDataFirstCls.operateData.curlocation=="Thailand")
//            {
...
//                $("#setting_fircls_head_img1").css("margin","18px 0 0 35px");
                $(".setting_first_ul2").css("left","510px");
                $(".setting_first_ul2").css("padding","0 472px 0 78px");
//                $(".setting_first_title_img1").css("margin","20px 20px 0 80px");
                $(".setting_first_list").css("background-image",'url("../img/setting_fir_bg.png")');
...
//                $("#setting_fircls_head_img1").css("margin","18px 35px 0 0");
                $(".setting_first_ul2").css("right","510px");
                $(".setting_first_ul2").css("padding","0 78px 0 472px");
//                $(".setting_first_title_img1").css("margin","20px 80px 0 20px");
                $(".setting_first_list").css("background-image",'url("../img/setting_fir_left_bg.png")');
...
function SettingMenuEscHandler() {
    try {
        debugPrint("in the em SettingMenuEscHandler");
...
//   if(PageDataFirstCls.operateData.curlocation=="Thailand"
//       ||PageDataFirstCls.operateData.curlocation=="Malaysia")
//   {
//       $("#settings_first_ul_setting_first_ul2_sys5>li:nth-child(6)").css("display","block");
//       $("#settings_first_ul_setting_first_ul2_sys5>li:nth-child(7)").css("display","block");
//   }
//    else
//   {
//       $("#settings_first_ul_setting_first_ul2_sys5>li:nth-child(6)").css("display","none");
//       $("#settings_first_ul_setting_first_ul2_sys5>li:nth-child(7)").css("display","none");
//   }
    if($("#settings_first_ul_setting_first_ul2_sys1_setting_first_content_text4_img_sys1").length > 0){ //新兴和sa为1
        //$("#settings_first_ul_setting_first_ul2_sys1_setting_first_content_text4_img_sys1").css("visibility","visible");
        debugG('default(em) folder');
    }
  //  setWizardSetFlag(0);
        ...
        case 2://channel
            switch (this.SelectedIndex) {
                ...
                case 6: //channelAdvanced
                    settingChSetCreateChnnelAdvancedPage();
...
//                            hiWebOsFrame.settingsupdatefir.rewriteDataOnly();
//                            StartDetectVer(1);
//                            SetRecentUse("Check OAD Upgrade",5,4);
//                        });
//                    });
//                    break;
//                    }
...
function settingChSetCreateChnnelAdvancedPage(){
    try {
        hiWebOsFrame.createPage('setting_chnl_advanced', null, hiWebOsFrame.settingsFirst, null, function (SettingChnlAdvancedPage) {
            debugG("ChnlAdvanced");
            hiWebOsFrame.SettingChnlAdvancedPage = SettingChnlAdvancedPage;
...
function FactoryResethandler(actionId, convertedResult) {
    try
    {
       ...
       // debugPrint(' ' + JSON.stringify(convertedResult));
        ...
        startWizard(2);
        sendAM(":am,am,:start=hbbtv");  //sync @zhaotongqing
...
function settingFirDisableChannelItem(){
    try{
        ...
        if(hiWebOsFrame.getPageByIdFromSdkPages(moduleOriginId).module == "app"){
    ...
    if(data.operateData.settingdisablelist[2].length > 0){
        debugPrint("---EM--- settingFirDisableChannelItem"+data.operateData.settingdisablelist[2],DebugLevel.ALWAYS);
    }
}
function settingFirPageSetChannelCurrTunerMode(type){
    try{
        ...
        debugPrint("settingFirPageSetChannelCurrTunerMode:"+ ex.message,DebugLevel.ERROR);
    }
...
function settingFirNetworkInit(){
    try{
        ...
        if(tv == true){
            ...
            debugPrint("settingFirNetworkInit:currDMRFlag="+data.operateData.currDMRFlag,DebugLevel.ALWAYS);
...
function settingFirPageSetNetworkDMRSwitch(type){
    debugPrint("settingFirPageSetNetworkDMRSwitch:type="+type,DebugLevel.ALWAYS);
    var data = PageDataFirstCls;
...
function GetUpdateMenu()
{
    try
    {
        ...
        if(PageDataFirstCls.operateData.curlocation!="Thailand"
            &&PageDataFirstCls.operateData.curlocation!="Malaysia")
        {
            PageDataFirstCls.settings_first_ul.Data[5] ={
             "setting_first_title_text1": { "Data": "About"}, "setting_first_title_img1": { "Data": "img/setting_fir_tv_unselsect.png"}, "setting_first_title_img2": {Data: "img/setting_fir_tv_selsect.png"},
            "setting_first_ul2": { "Data": [
            {
                "setting_first_content_text1": {Data: ""}, "setting_first_content_text2": {Data: ""}, "setting_first_content_text3": { "Data": "System Info"}, "setting_first_content_text4_img": {Data: ""},"setting_first_content_text4": {Data: ""}
...
//            }
           ...
           // OAD_SWITCH=100;
            OAD_UPDATE=100;
            PageDataFirstCls.operateData.settingdisablelist[5]=[5];
        }
        else
        {
            PageDataFirstCls.settings_first_ul.Data[5] ={
...
//                    {
//                        "setting_first_content_text1": { "Data": "Auto OAD Upgrade"}, "setting_first_content_text2": { "Data": "On"}, "setting_first_content_text3": { "Data": ""}, "setting_first_content_text4_img": {Data: ""},"setting_first_content_text4": {Data: ""}
//                    },
                    {
                        "setting_first_content_text1": {Data: ""}, "setting_first_content_text2": {Data: ""}, "setting_first_content_text3": { "Data": "Check OAD Upgrade"}, "setting_first_content_text4_img": {Data: ""},"setting_first_content_text4": {Data: ""}
                    },
                    {
                        "setting_first_content_text1": {Data: ""}, "setting_first_content_text2": {Data: ""}, "setting_first_content_text3": { "Data": "Restore To Factory Default"}, "setting_first_content_text4_img": {Data: ""},"setting_first_content_text4": {Data: ""}
                    }
          ...
          //  OAD_SWITCH=4;
            OAD_UPDATE=4;
            FACTORY_RESET=5;
            PageDataFirstCls.operateData.settingdisablelist[5]=[];
        }
    }catch (e)
    {
        debugPrint(e.message)
...
function timerPrint()
{
    debugPrint("t1 timer: " + t1 + "t2 timer: " + t2, DebugLevel.ERROR);
}
function timeout()
{
    t1 = setTimeout(function () {
            timerPrint();
            t2 = setTimeout(arguments.callee, 5000);//"timerPrint()"
        }, 5000);
}
