...
{
	PageDataSettingQsList1.operateData.curoption = tv ? PageDateQuickSet.operateData.cursubselect : 'audioLanguage';
...
var PageDataSettingQsList1= {
	...
	rewrite:function(pageData) {
		...
		if(hiWebOsFrame.getHTMLDir() == HTMLDIR.LTR) {
			...
			$("#setting_qs_list1_srcobar_container_id").css("float","right");
			$("#setting_qs_list1_srcobar_container_id").css("margin","25px 15px 0 0");
		}
		else {
			$("#setting_qs_list1_ul1").css("float","right");
			$("#setting_qs_list1_ul1").css("right","65px");
			$("#setting_qs_list1_srcobar_container_id").css("float","left");
			$("#setting_qs_list1_srcobar_container_id").css("margin","25px 0 0 45px");
		}
...
function SettingQsList1EscHandler()
{
	...
	{
		hiWebOsFrame.settingsysqS.getCaE('setting_qsp_ul').setSelectedIndex(1);
		PageDateQuickSet.setting_qsp_ul.SelectedIndex = 1;
