...
function getSettingCloseCaptionPageData(opt)
{
    opt.CaE= [
        ...
        },
        {
            ...
            "onFocusFun":"SetingonFocusFun",
            "onBlurFun":"SetingonBlurFun"
...
//            "disable": false,
//            "SelectedIndex": 0,
//            "nav": {"downTo": "setting_sys_cc_ul4","upTo":"setting_sys_cc_ul2"},
//
//            "classes": {
//                "normal": "setting_sys_navibar1_normal", "focus": "setting_sys_navibar1_focus","dataSelected":"setting_sys_navibar1_dataselect",
//                "disable":"setting_sys_navibar1_disable","disableDataSelected":"setting_sys_navibar1_data_dis_select"
//            },
//            "handler": {
//               // "aftEnterHandler": "SettingSysCCUl3Enter",
...
function SettingSysCCUl1Enter()
{
    ...
    SetRecentUse("Closed Caption",4,4);
}
...
function SetingonFocusFun(){//omg 2015-12-21 add marquee
    var beginidc=(undefined===this.BeginIdx)?0:this.BeginIdx;
    var idc=this.SelectedIndex-beginidc;
    if (idc <= 3)
        restoreMarqueeCommon("#"+this.id+" span", -1, idc , 468);
}
function SetingonBlurFun(){//omg 2015-12-21 add marquee
    var beginidc=(undefined===this.BeginIdx)?0:this.BeginIdx;
    var idc=this.SelectedIndex-beginidc;
    if (idc <= 3)
        restoreMarqueeCommon("#"+this.id+" span", idc, -1 , 468);
}
