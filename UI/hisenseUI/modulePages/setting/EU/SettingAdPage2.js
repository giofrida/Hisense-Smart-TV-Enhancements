...
//                "aftUpHandler":"SettingSysadfocus",
        ...
        },
        {
            ...
            "nav":{"downTo": "setting_sys_ad_btn4", "upTo": "setting_sys_ad_btn6"},
            "handler": {
                "aftDownHandler":"SettingSysadfocus",
                "aftUpHandler":"SettingSysadfocus",
...
//        },
        ...
        },
        {
            ...
            "nav":{"downTo": "setting_sys_ad_control1", "upTo": "setting_sys_ad_btn3"},
            "handler": {
                "aftDownHandler":"SettingSysadfocus",
                "aftUpHandler":"SettingSysadfocus",
        ...
        {
            "id": "setting_sys_ad_auto_sleep_str1",
            "description": "",
            "CaEType": "div"
        },
        {
            ...
            "nav": {"upTo": "setting_sys_ad_btn4", "downTo":"setting_sys_ad_control2"},
            "CaEType": "FlipSwitch",
            "disable": false,
...
//        {
//            "id": "setting_sys_ad_powerindicator_str1",
//            "description": "",
//            "CaEType": "div"
//        },
//        {
...
//                "normal": "flipSwitchNormal", "focus": "flipSwitchFocus", "disable": "flipSwitchDisable", "selected": "flipSwitchSelected"
//            },
//            "nav": {"upTo": "setting_sys_ad_control1"},
//            "CaEType": "FlipSwitch",
//            "SwitchRadio":"50%",//显示的比例
//            "FlipSwitchConfig":{
//                switchTypeId:"switchType",//目前开(true)还是关(false) id
...
//    "setting_sys_ad_btn7":{Data:"Adjust"},
    ...
    "setting_sys_ad_auto_sleep_str1":{Data:"Auto Sleep"},
...
//function SettingSysAdSubModeEnter()
//{
//    //todo setvalue js angd select rewrite page
//    SetSubtitlelMode(this.SelectedIndex);
//    this.page.operateData.cursubeselect=this.SelectedIndex;
//    this.page.rewriteDataOnly();// to change to rewriteDataOnly
//    SetRecentUse("Subtitle",4,6);
//}
function SettingSysAdCtrlEnHandler(operateData,data){
    ...
    if(this.id=="setting_sys_ad_control1")
    {
        SetAutoSleepSwitch( operateData[this.id].switchType);
...
function SetAutoSleepSwitch(type)
{
    try
    {
    if(type)
    {
        model.system.setAutoSleepSwitch(1);
        debugPrint("SetAutoSleepSwitch on",DebugLevel.INFO);
    }
    else
    {
        model.system.setAutoSleepSwitch(0);
        debugPrint("SetAutoSleepSwitch off",DebugLevel.INFO);
    }
    }catch (e)
    {
...
//    var element={};
//    debugPrint("get the eu input list is "+JSON.stringify(temp2));
//    var cout=parseInt( temp2.length/6);
//    var sourceuid=model.system.getSystemDefaultInput();///////////////
//     debugPrint("get the eu sourceuid is "+sourceuid);
