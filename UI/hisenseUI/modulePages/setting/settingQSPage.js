...
//    var headphoneInsertState =  1;
	...
	else
	{
		try{
			...
			if(PageDateQuickSet.operateData.applist.length!=0 || tmpCurCountryCode == 'AUS')
			{
...
var PageDateQuickSet = {
    ...
    rewrite: function(pageData) {
        ...
        if(hiWebOsFrame.getHTMLDir() == HTMLDIR.LTR) {
            $("#setting_sys_qs_page"+" *").css("float","left");
            $("#setting_qsp_more").attr("src","img/setting_qs_right_arrow.png");
            $(".setting_qsp_bottom").css("margin","104px 0 0 95px");
	        $("#setting_qsp_bottom_img").attr("src", "img/setting_qs_right.png");
        }
        else {
            $("#setting_sys_qs_page"+" *").css("float","right");
            $("#setting_qsp_more").attr("src","img/setting_qs_left_arrow.png");
            $(".setting_qsp_bottom").css("margin","104px 95px 0 0");
	        $("#setting_qsp_bottom_img").attr("src", "img/setting_qs_left.png");
	        $("#setting_qsp_bottom_img").css("margin-right","18px");
        }
    }
};
