...
////        pageData.setting_sys_lang_dig_text2.Data=pageData.operateData.curdig;
           ...
           if(pageData.operateData.isHimediaOn)
        {
            ...
            $("#setting_sys_lang_dec_page2").css('color',"rgba(178,184,191,0.3)");
               ...
               if(pageData.operateData.curCounty=="Taiwan")
               {
                   pageData.setting_sys_lang_dec_page3.disable=true
               }
               else
...
function getSettingLang1OnOpen(){
    ...
    if(PageDataSettingSysLang.operateData.curCounty=="Taiwan")
    {
        $("#setting_sys_lang_dec").css("display","none");

    }
    else
    {
        $("#setting_sys_lang_dec").css("display","block");
...
function languagepageinit()
{
    ...
    var temp=[];
    var i;
    PageDataSettingSysLang.operateData.curCounty=hiWebOsFrame.getCurrentCountry();
