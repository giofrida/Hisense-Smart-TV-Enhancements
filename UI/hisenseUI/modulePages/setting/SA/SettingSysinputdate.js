...
function getSettingSysinputdateData(opt)
{
    opt.CaE=[
...

        {
            ...
            "nav": { "leftTo":"setting_sys_inputdate_input2","rightTo":"setting_sys_inputdate_input3","downTo":"setting_sys_inputdate_btn1"},
            "handler":{
        ...
        },
        {
            ...
            "nav": { "leftTo":"","rightTo":"setting_sys_inputdate_input1","downTo":"setting_sys_inputdate_btn1"},
            "handler":{
                "aftEnterHandler":"invokeSKB",
                'aftEscHandler':"SettingSysinpurdateCancel"//点击enter事件后处理开关转换
        ...
        },
        {
            ...
            "nav": { "leftTo":"setting_sys_inputdate_input1","rightTo":"","downTo":"setting_sys_inputdate_btn1"},
            "handler":{
                "aftEnterHandler":"invokeSKB",
                'aftEscHandler':"SettingSysinpurdateCancel"//点击enter事件后处理开关转换
...
//
            ...
            PageDataSettingTimedate.operateData.curdate=value2+"/"+value1+"/"+value3;
