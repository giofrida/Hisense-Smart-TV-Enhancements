...
function getSettingAdPageData(opt)
{
    opt.CaE=[
        ...
        },
        {
            ...
            "nav":{"downTo": "setting_sys_ad_btn3", "upTo": "setting_sys_ad_btn2"},
            "handler": {
                "aftDownHandler":"SettingSysadfocus",
                "aftUpHandler":"SettingSysadfocus",
        ...
        },
        {
            ...
            "nav":{"downTo": "setting_sys_ad_btn6", "upTo": "setting_sys_ad_btn5"},
            "handler": {
                "aftDownHandler":"SettingSysadfocus",
                "aftUpHandler":"SettingSysadfocus",
        ...
        },
        {
            ...
            "nav":{"downTo": "setting_sys_ad_control2", "upTo": "setting_sys_ad_btn6"},
            "handler": {
                "aftDownHandler":"SettingSysadfocus",
                "aftUpHandler":"SettingSysadfocus",
...
function SetSubtitlelMode(type)
{
    ...
    {
        case 0:
            model.basicSetting.setEnumDvbModeSubtitle(0);
            break;
        case 1:
            model.basicSetting.setEnumDvbModeSubtitle(1);
            break;
        case 2:
            model.basicSetting.setEnumDvbModeSubtitle(2);
            break;
    }
