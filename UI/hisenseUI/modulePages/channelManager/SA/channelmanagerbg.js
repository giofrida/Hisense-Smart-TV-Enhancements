...
function ChannelManagerBg() {
    ...
    var pageCount = 8, pageSize = 7, selectedCount = 0, selectedItems = [],
    ...
    self.pageData = {
        ...
        chl_manager_bg_button_txt2: {Data: "Rename"},
...
//        clearOperateData();
    ...
    self.setshowImg = function () {
        if (moveflag) {
            ...
            debugPrint('destItem::::: ' + objToString(destItem));
            ...
            if (tv) {
                model.servicelist.MoveMoreChannel(oprData.list.uid, destItem.uid, moveItemsNum);
            }
            else {
...
//            a.hiFocus();
   ...
   self.AddButtonClass =function(){
        ...
        $("#chl_manager_bg_button2").attr("src","img/common/yellow.png");
    }
