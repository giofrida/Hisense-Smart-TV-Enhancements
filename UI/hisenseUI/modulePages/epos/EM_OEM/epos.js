...
function changeEPOSContent() {
    ...
    if (currentPlatform.indexOf('5655') > -1) {
        $("#table_uhd").css("background-image", "url(img/epos/EM_OEM/uhd_epos_uhd_panel_5655.png)");
        $("#table_picture").css("background-image", "url(img/epos/EM_OEM/uhd_epos_picture_panel_5655.png)");
        $("#table_connect").css("background-image", "url(img/epos/EM_OEM/uhd_epos_connect_panel_5655.png)");


    } else {
        $("#table_uhd").css("background-image", "url(img/epos/EM_OEM/uhd_epos_uhd_panel.png)");
        $("#table_picture").css("background-image", "url(img/epos/EM_OEM/uhd_epos_picture_panel.png)");
        $("#table_connect").css("background-image", "url(img/epos/EM_OEM/uhd_epos_connect_panel.png)");
