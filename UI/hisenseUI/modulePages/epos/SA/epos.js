...
function changeEPOSContent() {
    ...
    if ("APP_5890_SA" == currentPlatform) {
        $("#table_uhd").css("background-image", "url(img/epos/SA/uhd_epos_uhd_panel_5657.png)");
        ...
        switch (hiWebOsFrame.getCurrentCountry()) {
            case "Argentina":
                $("#table_picture").css("background-image", "url(img/epos/SA/uhd_epos_picture_panel_1_5657.png)");
                break;
            case "Brazil":
                $("#table_picture").css("background-image", "url(img/epos/SA/uhd_epos_picture_panel_2_5657.png)");
                break;
            case "Philippines":
                $("#table_picture").css("background-image", "url(img/epos/SA/uhd_epos_picture_panel_3_5657.png)");
                break;
            case "Uruguay":
            case "Colombia":
                $("#table_picture").css("background-image", "url(img/epos/SA/uhd_epos_picture_panel_4_5657.png)");
                break;
            default :
                $("#table_picture").css("background-image", "url(img/epos/SA/uhd_epos_picture_panel_5_5657.png)");
                break;
        }

    } else {
        $("#table_uhd").css("background-image", "url(img/epos/SA/uhd_epos_uhd_panel.png)");
        debugPrint("changeEPOSContent begin! currentPlatform is " + hiWebOsFrame.getCurrentCountry());
        switch (hiWebOsFrame.getCurrentCountry()) {
            case "Argentina":
                $("#table_picture").css("background-image", "url(img/epos/SA/uhd_epos_picture_panel_1.png)");
                break;
            case "Brazil":
                $("#table_picture").css("background-image", "url(img/epos/SA/uhd_epos_picture_panel_2.png)");
                break;
            case "Philippines":
                $("#table_picture").css("background-image", "url(img/epos/SA/uhd_epos_picture_panel_3.png)");
                break;
            case "Uruguay":
            case "Colombia":
                $("#table_picture").css("background-image", "url(img/epos/SA/uhd_epos_picture_panel_4.png)");
                break;
            default :
                $("#table_picture").css("background-image", "url(img/epos/SA/uhd_epos_picture_panel_5.png)");
                break;
        }
    }
    //根据国家切换APP内容
    ...
    if ("HIS_EPOS_HD" == EPOSresolution) {
        if (MEMC_SUPPORT == 1) {
            $("#table_uhd").css("background-image", "url(img/epos/SA/uhd_epos_uhd_panel_led.png)");

        } else {
            $("#table_uhd").css("background-image", "url(img/epos/SA/uhd_epos_uhd_panel_led_nomemc.png)");
        }
        var langIdx = 0;
        try {
            langIdx = model.language.getOsd();
        ...
        if (MEMC_SUPPORT == 1) {
            ...
            $("#table_uhd").css("background-image", "url(img/epos/SA/uhd_epos_uhd_panel_nomemc.png)");
        }
        var langIdx = 0;
        try {
            langIdx = model.language.getOsd();
